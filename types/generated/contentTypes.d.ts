...
export interface ApiArticuloArticulo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    habilitado: Attribute.Boolean & Attribute.DefaultTo<true>;
    ...
    carrera: Attribute.Relation<
      ...
      'api::carrera.carrera'
    >;
    aula: Attribute.String;
    condicion: Attribute.String;
    registrado: Attribute.Relation<
      'api::articulo.articulo',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiCambioCambio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    prev_value: Attribute.Text;
    llave: Attribute.String & Attribute.Required;
    new_value: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::cambio.cambio',
...
export interface ApiCarreraCarrera extends Schema.CollectionType {
...
export interface ApiFacultadFacultad extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nombre: Attribute.String & Attribute.Unique;
    descripcion: Attribute.Text;
    carreras: Attribute.Relation<
      'api::facultad.facultad',
      'oneToMany',
      'api::carrera.carrera'
    >;
...
export interface ApiMantenimientoMantenimiento extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    tipo: Attribute.String & Attribute.Required;
    detalle: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::mantenimiento.mantenimiento',
